...
var problems = new Array("If a pop-up says you've won a prize but asks for personal information, what should you do?", "Which of these is a strong password?", "Which of these should you NOT share on social media?",
"If someone online asks you to keep a secret from your parents, what should you do?.", "What's the best action if you receive a message with a link from an unknown sender?")
function create()
{
